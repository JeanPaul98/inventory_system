    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
                            ...
                            <tr>
                                <td colspan="8" class="text-center">
                                    <span class="text-danger">
                                        Veuillez rechercher et sélectionner des produits !
                                    </span>
                                </td>
                            </tr>
                        @endif
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr>
                                <th>Taxe sur la commande ({{ $global_tax }}%)</th>
                                <td>(+) {{ format_currency(Cart::instance($cart_instance)->tax()) }}</td>
                            </tr>
                            <tr>
                                <th>Réduction ({{ $global_discount }}%)</th>
            ...
            <div class="form-row">
                <div class="col-lg-4">
                    <div class="form-group">
                        <label for="tax_percentage">Taux de taxe (%)</label>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label for="shipping_amount">Expédition</label>
            ...
            <div class="form-group d-flex justify-content-center flex-wrap mb-0">
                <button wire:click="resetCart" type="button" class="btn btn-pill btn-danger mr-3"><i class="bi bi-x"></i> Réinitialiser</button>
                <button wire:loading.attr="disabled" wire:click="proceed" type="button" class="btn btn-pill btn-primary" {{  $total_amount == 0 ? 'disabled' : '' }}><i class="bi bi-check"></i> Procéder</button>
            </div>
        </div>
    </div>
